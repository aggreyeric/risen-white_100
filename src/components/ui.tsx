/** Small, dependency-free UI primitives + inline icons. */
...
export function StellarMark({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" aria-hidden="true">
      <path
        d="M32 12l4.6 11.6L48 28l-11.4 4.4L32 44l-4.6-11.6L16 28l11.4-4.4L32 12z"
        fill="url(#rm)"
      />
      <path
        d="M20 46l12-8 12 8"
      ...
      />
      <defs>
        <linearGradient id="rm" x1="12" y1="12" x2="52" y2="52" gradientUnits="userSpaceOnUse">
